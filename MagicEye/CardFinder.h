...
public:
	...
	void discernPartialCards();            /// TODO: could live in board manager class // needs to be called after frame colors are assigned.  more reason for new class
...
private:
	...
	TableCard extractCardImage(const cv::Mat & fromScene, const cv::RotatedRect boundingRect, const cv::Point worldPosition, const cv::Rect & tableBB, const bool isFullCard) const;
